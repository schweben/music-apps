...
describe('Transpose Component', () => {
  ...
  describe('Transposition - All key combinations', () => {
    describe.each([
      ...
      { testSourceInstrument: "E♭", testTargetInstrument: "A", testSourceNote: "D", expectedInterval: "down a augmented 4th", expectedNote: "G♯/A♭" },
      { testSourceInstrument: "E♭", testTargetInstrument: "A", testSourceNote: "D♯/E♭", expectedInterval: "down a augmented 4th", expectedNote: "A" },
      { testSourceInstrument: "E♭", testTargetInstrument: "A", testSourceNote: "E", expectedInterval: "down a augmented 4th", expectedNote: "A♯/B♭" },
      ...
      { testSourceInstrument: "E♭", testTargetInstrument: "A", testSourceNote: "G♯/A♭", expectedInterval: "down a augmented 4th", expectedNote: "D" },
      { testSourceInstrument: "E♭", testTargetInstrument: "A", testSourceNote: "A", expectedInterval: "down a augmented 4th", expectedNote: "D♯/E♭" },
      { testSourceInstrument: "E♭", testTargetInstrument: "A", testSourceNote: "A♯/B♭", expectedInterval: "down a augmented 4th", expectedNote: "E" },
